...
## 🛠 Skills
- **Web Development:** HTML, CSS, Sveltekit, Svelte, Angular, Tailwind, Typescript
...
- I have 2 cats, one is named Jiji, named after the cat from [Kiki's Delivery Service](https://ghibli.fandom.com/wiki/Jiji), and the other is named Willow
